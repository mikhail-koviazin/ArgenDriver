...
export const ChangelogScreen: FC<MainTabScreenProps<"Changelog">> = function ChangelogScreen(
  _props,
) {
  ...
  useEffect(() => {
    const unsubscribe = _props.navigation.addListener("focus", () => {
      setChanges(
        i18n.translate<ChangelogEntry[]>(["changelogScreen.changes"], {
          returnObjects: true,
        }) as ChangelogEntry[],
      )
    })
